...
{
#if defined(CONFIG_TARGET_1888TX018_MB115_01_SPL_FIRST_DEVICE_MMC)
	return BOOT_DEVICE_MMC1;
#elif defined(CONFIG_TARGET_1888TX018_MB115_01_SPL_FIRST_DEVICE_SPI_FLASH)
	return BOOT_DEVICE_SPI;
#elif defined(CONFIG_TARGET_1888TX018_MB115_01_SPL_FIRST_DEVICE_NOR)
	return BOOT_DEVICE_NOR;
#elif defined(CONFIG_TARGET_1888TX018_MB115_01_SPL_FIRST_DEVICE_UART_EDCL)
