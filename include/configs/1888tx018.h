...
#define RCM_POST_WORD_ADDR_SIZE 32
#define RCM_POST_WORD_ADDR (CONFIG_SYS_SPL_MALLOC_START - RCM_POST_WORD_ADDR_SIZE)

#define RCM_1888TX018_SPL_FDT_MAX_LEN 0x1000
#define RCM_PPC_SPL_ADDR_LIMIT (RCM_POST_WORD_ADDR - RCM_1888TX018_SPL_FDT_MAX_LEN)
...
#define CONFIG_SYS_INIT_DDR0_ADDR_PHYS (0x0000000000ULL)
#define CONFIG_SYS_INIT_DDR1_ADDR_PHYS (0x0200000000ULL)
#define CONFIG_SYS_DDR_SDRAM_BASE      0x40000000
#define CONFIG_SYS_SDRAM_BASE          CONFIG_SYS_DDR_SDRAM_BASE
#define CONFIG_SYS_DDR_SIZE            SZ_4G
#define CONFIG_MAX_MEM_MAPPED          SZ_2G
...
#ifdef CONFIG_SPL_BUILD
#define MAKE_STRESS_TEST 1
#if MAKE_STRESS_TEST
/* test POST memory test */
#define CONFIG_POST                (CONFIG_SYS_POST_MEM_STRESS)	 
#define CONFIG_SYS_POST_WORD_ADDR  RCM_POST_WORD_ADDR
#endif
#endif
